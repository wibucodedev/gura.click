...
const OFFLINE_PAGE = "/index.html"; // offline
...
const CACHE_BLACKLIST = [
  (str) => {
    return (
      !str.startsWith("https://gura.waifu.click") &&
      !str.startsWith("https://fonts.googleapis.com") &&
      !str.startsWith("https://fonts.gstatic.com")
    ); // && duplicate
  },
];
